    ...
    <?php
     if (isset($_GET['error'])) {
       ...
       elseif ($_GET['error']== "userinvalid") {
         echo '<p style="color:red;text-align:center;padding-top: 30px;">Username ไม่ถูกต้อง!</p>';
       }
       elseif ($_GET['error']== "wrongpassword") {
         echo '<p style="color:red;text-align:center;padding-top: 30px;">รหัสผ่านไม่ถูกต้อง!</p>';
       }
     }
   ?>
