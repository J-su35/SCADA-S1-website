<?php
  $page = "แจ้งปัญหาอุปกรณ์ในระบบจำหน่าย";
  include_once 'header7s.php';
  require_once 'process3c.php';
?>
    ...
    <?php
      ...
      $result = $mysqli->query("SELECT * FROM equip_problems3") or die($mysqli->error);
        ...
        <table class="table table-sm">
          ...
          <tbody id="myTable">
            ...
            <?php if($_SESSION['username']=='scadaadmin' || $_SESSION['username'] =="scadas1"): ?>
                <td>
                    <a href="bad_equip3.php?edit=<?php echo $row['id']; ?>" class="btn btn-info">แก้ไข</a>
                    <a href="process3c.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger">ลบ</a>
                </td>
            <?php else: ?>
                <td></td>
            <?php endif; ?>
    ...
    <!-- debug part End -->
      ...
      <div class="row justify-content-center">
        <form action="process3c.php" method="post">
