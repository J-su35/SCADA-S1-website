...
?>
      ...
      <div class="row justify-content-center">
        <table class="table">
          ...
          <tbody id="myTable">
            ...
            <?php if ($_SESSION['username'] == "scadaadmin" || $_SESSION['username'] =="scadas1" || $_SESSION['username'] =="commuadmin" || $_SESSION['username'] =="madadmin"): ?>
                <td>
    ...
    <?php if ($_SESSION['username'] == "scadaadmin" || $_SESSION['username'] =="commuadmin" || $_SESSION['username'] =="madadmin"): ?>
