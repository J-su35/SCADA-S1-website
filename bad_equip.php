        ...
        <table class="table table-sm">
          <thead>
            ...
            <?php if($_SESSION['username']=='adminS1'): ?>
                <td>
                    <a href="bad_equip.php?edit=<?php echo $row['id']; ?>" class="btn btn-info">แก้ไข</a>
                    <a href="process3.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger">ลบ</a>
                </td>
            <?php else: ?>
                <td></td>
            <?php endif; ?>
      ...
      <div class="row justify-content-center">
        <form action="process3.php" method="post">
          ...
          <div class="form-group">
            ...
            <input type="radio" name="action" value="รอการแก้ไข" required> รอการแก้ไข
            <input type="radio" name="action" value="แก้ไขแล้ว" required> แก้ไขแล้ว
          </div>
          <div class="form-group">
