  ...
  <div class="container my-3">
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="radio" name="voltage" value="115kV" class="form-check-input"> 115 kV<br>
        <input type="radio" name="voltage" value="22,33kV" class="form-check-input"> 22, 33 kV
      </div>
      <div class="form-group">
...
?>
    ...
    if (isset($_POST["submit"])) {
      ...
      if (isset($voltage) && isset($voltage) == "115kV") {
        // if (isset($filetype) && isset($filetype) == "AutoCAD_2007") {
        if ($filetype == "AutoCAD_2007") {
          $title = $_POST["title"];
          // if (move_uploaded_file($_FILES["dwg_file"]["tmp_name"],"sigleline/115kV/2007/" . $_FILES["dwg_file"]["name"])) {
        ...
        // } elseif (isset($filetype) && isset($filetype) == "AutoCAD_2013") {
          ...
          $title = $_POST["title"];
          // if (move_uploaded_file($_FILES["dwg_file"]["tmp_name"],"sigleline/115kV/2013/" . $_FILES["dwg_file"]["name"])) {
          if (move_uploaded_file($_FILES["dwg_file"]["tmp_name"],"sigleline/" . $_FILES["dwg_file"]["name"])) {
            $sql = mysqli_query($conn,"INSERT INTO sigleline(title, filename, voltage, filetype) VALUES('$title', '$pname', '$voltage', '$filetype')");
