$(document).ready(function() {
    ...
    function updateChart(updateFrom){
        ...
        var chart = $('#load-chart').highcharts();
        chart.showLoading();
        $.getJSON('data.php',{date: $("#datepicker").val(), mode: 'spp-vspp-province', area: $("#area_selector").val(), province: province}, function(data) {
    ...
    function showCurve(updateFrom){
        ...
        $.getJSON('data.php',{date: $("#datepicker").val(), mode: 'spp-vspp-province', area: $("#area_selector").val(), sppvspp: $("#spp_vspp_selector").val(), province: province, hvmv: $("#hvmv_selector").val(), type: $("#type_selector").val()}, function(data) {
            //alert(data['SubID']);
            if(data['available'] == 1){
                /*var chart = $('#load-chart').highcharts();
                chart.destroy();*/
                ...
                var regions = data['name'];
                if(data['12Area'] == 1){
                    regions = ['N1','N2','N3','C1','C2','C3','NE1','NE2','NE3','S1','S2','S3'];
                }
