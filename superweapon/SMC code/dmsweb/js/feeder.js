$(document).ready(function() {
    ...
    function showCurve(){
        ...
        //$("#load-chart").fadeOut();
        $.getJSON('data.php',{date: $("#datepicker").val(), mode: 'feeder', area: $("#area_selector").val(), substation: $("#substation_selector").val()}, function(data) {
            //alert(data['SubID']);
            if(data['available'] == 1){
                /*var chart = $('#load-chart').highcharts();
                chart.destroy();
            ...
            /*if($("#area_selector").val() == "Total"){
                ...
                chartHeader = 'โหลดของสถานี '+$("#substation_selector").val()+' วันที่ '+ day;
           // }
