...
<html>
	<head>
		...
		<script type="text/javascript" src="js/spp-vspp-province.js"></script>
				...
				<div class="col-lg-7" style="padding-left: 5px">
					<form class="form-inline" role="form" id="select_form" name="select_form">
			            ...
			            <div class="form-group">
			                ...
			                <input type="text" class="form-control text-center col-xs-3" id="datepicker" readonly value="<?php echo date("d-m-Y"); ?>" style="font-weight: bold; font-size: 16px; width: 120px; height: 34px; cursor: pointer; color: #000000; background: #ffffff; box-shadow: 0px 0px 8px #000000; margin: 3px">
			                <label class="sr-only" for="area_selector">เลือกเขต</label>
			                <select id="area_selector" name="List1" class="form-control col-xs-3" style="width:80px; color: #000000; background: #ffffff; box-shadow: 0px 0px 8px #000000; margin: 3px 2px; padding: 0px 4px">
			                	<?php
			                	$area = array('Total','N1','N2','N3','NE1','NE2','NE3','C1','C2','C3','S1','S2','S3');
			                	$areaCode = array('Total','11','12','13','21','22','23','31','32','33','41','42','43');
			                	$idx = 0;
			                ...
			                <select name='spp_vspp' id="spp_vspp_selector" class="form-control col-xs-3" style="width:100px; color: #000000; background: #ffffff; box-shadow: 0px 0px 8px #000000; margin: 3px 2px; padding: 0px 4px">
								<option value="Total" selected>SPP+VSPP</option>
								<option value="S">SPP</option>
								<option value="V">VSPP</option>
							</select>
<!--			                <select name='List2' id="province_selector">
								<option value="Total" selected>ทุกจังหวัด</option>
							</select>
-->
							<select name='hvmv' id="hvmv_selector" class="form-control col-xs-3" style="width:120px; color: #000000; background: #ffffff; box-shadow: 0px 0px 8px #000000; margin: 3px 2px; padding: 0px 4px">
								<option value="Total" selected>ทุกระดับแรงดัน</option>
								<option value="H">HV</option>
								<option value="M">MV</option>
							</select>
							<select name='type' id="type_selector" class="form-control col-xs-3" style="width:150px; color: #000000; background: #ffffff; box-shadow: 0px 0px 8px #000000; margin: 3px; padding: 0px 4px">
								<option value="Total" selected>ทุกประเภทพลังงาน</option>
								<option value="01">Biomass</option>
								<option value="02">Biogas</option>
								<option value="03">Solar</option>
								<option value="04">Waste</option>
								<option value="05">Wind</option>
								<option value="06">Hydro</option>
								<option value="07">Cogen</option>
								<option value="08">Etc</option>
							</select>
			            </div>
					</form>
				</div>
			...
			<div class="row chart">
				<div class="col-xs-12" style="padding:5px 5px 0 5px">
					<div class="text-center well" id="spantext" style="font-weight: bold; padding: 10px; margin-bottom: 5px">กรุณารอสักครู่ กำลังโหลดข้อมูล...</div>
