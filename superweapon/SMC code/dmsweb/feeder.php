...
if ($conn === false or mssql_select_db("Substation", $conn) === false) {
    die("Cannot connect or select SQL Server database feeder.php");
}

$query = "SELECT [SubstationCode] Sub
      ,[ThName] Subname
      ,[RegionCode] Area
  FROM [Substation].[dbo].[Substation]";
				...
				<div class="col-lg-7" style="padding-left: 5px">
					<form class="form-inline" role="form" id="select_form" name="select_form">
			            <div class="form-group">
			                ...
			                <input type="text" class="form-control text-center col-xs-4" id="datepicker" readonly value="<?php echo date("d-m-Y"); ?>" style="font-weight: bold; font-size: 16px; text-align: center; width: 120px; height: 34px; cursor: pointer; color:#000000; background: #ffffff; box-shadow: 0px 0px 8px #000000; margin: 3px">
			                <!-- <label class="sr-only" for="area_selector">เลือกเขต</label> -->
			                <select id="area_selector" name="List1" class="form-control col-xs-4" style="width:100px; color: #000000; background: #ffffff; box-shadow: 0px 0px 8px #000000; margin: 3px 2px">
			                	<?php
			                ...
			                <select name='List2' id="substation_selector" class="form-control col-xs-4" style="width:110px; color:#000000; background: #ffffff; box-shadow: 0px 0px 8px #000000; margin: 3px; display: none;" hidden>
