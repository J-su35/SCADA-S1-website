...
while ($row = mysqli_fetch_object($result)) {
	...
	array_push($provinceKeyList[trim($row->Area)], trim($row->Province));
	array_push($provinceNameList[trim($row->Area)], trim($row->ProvinceName));
	$provinceKeyNameList[trim($row->Province)] = trim($row->ProvinceName);
				...
				<div class="col-lg-7" style="padding-left: 5px">
					<form class="form-inline" role="form" id="select_form" name="select_form">
			            ...
			            <div class="form-group">
			                ...
			                <select id="area_selector" name="List1" class="form-control col-xs-4" style="width:90px; color: #000000; background: #ffffff; box-shadow: 0px 0px 8px #000000; margin: 3px 2px">
			                	<?php
